...
public sealed class CampaignSkillsTab : MonoBehaviour, ITabController
{
    private Tab? _tab;
    private TabGroup? _group;
    private GameObject? _host;
    private CampaignScreen? _view;
    ...
    internal void Initialize(SkillsAndMasteringScreen screen, bool isScav)
    {
        ...
        try
        {
            ...
            var host = UiElements.Rect("CampaignsContent", source.parent, source.sizeDelta.x, source.sizeDelta.y);
