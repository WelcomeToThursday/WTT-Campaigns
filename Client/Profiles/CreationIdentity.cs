...
{
    private const string ScreenName = "SeasonalNativeIdentity";
    ...
    private static void RemoveInheritedPreviewModels(EftAccountSideSelectionScreen screen)
    {
        ...
        foreach (var view in screen.GetComponentsInChildren<PlayerModelView>(true))
        {
            foreach (var model in view.GetComponentsInChildren<MenuPlayerPoser>(true))
            {
                model.gameObject.SetActive(false);
                model.GetComponent<PlayerBody>()?.Dispose();
