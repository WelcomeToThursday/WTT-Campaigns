...
internal class StaminaRestorationPatch(string methodName) : ModulePatch("WTT.Campaigns." + methodName)
{
    ...
    private static void Postfix(Physical __instance, MethodBase __originalMethod, ref float __result)
    {
        ...
        var bodyPart = __originalMethod.Name == nameof(Physical.GetHandsRestorationFunc) ? "arms" : "legs";
