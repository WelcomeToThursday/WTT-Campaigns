...
{
    internal static bool PreservedComponent(string name) => name is
        "UnityEngine.Rigidbody" or "UnityEngine.AudioSource" or "UnityEngine.Light"
        or "BaseBallistic" or "EFT.Ballistics.BallisticColliderComposer"
        or "HotObject" or "StaticDeferredDecal" or "StencilShadow";

    internal static string Restriction(string name) => name switch
    {
