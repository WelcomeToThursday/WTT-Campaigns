...
`WTT-Campaigns.Shared` contains the contracts and game-independent logic used by the client and server. Namespaces match folders beneath `Shared`, for example `WTT.Campaigns.Shared.Effects.Items`.
