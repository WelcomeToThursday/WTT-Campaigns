...
internal static class AiControlsChecks
{
    ...
    internal static void Run(AssemblyDefinition assembly, Action<bool, string> check)
    {
        ...
        check(
            consumedGroups.SetEquals(generatedGroups),
            "Every AI inspector group consumed by refresh is generated by Prepare"
        );
        ...
        var boundButtons = CallArguments(bind, "Button")
            ...
            .ToHashSet(StringComparer.Ordinal);
        check(
            generatedButtons.SetEquals(boundButtons),
            "Every AI button generated by Prepare is bound by BindAiControls"
        );
        ...
        var boundFields = CallArguments(bind, "Input")
            ...
            .ToHashSet(StringComparer.Ordinal);
        check(
            generatedFields.SetEquals(boundFields),
            "Every AI input generated by Prepare is bound by BindAiControls"
        );
        ...
        check(
            modeLoad.Length == 3
                ...
                && modeLoad[1].Operand is FieldReference mode && mode.Name == "_mode"
    ...
    private static IEnumerable<string> StringOperands(MethodDefinition method) =>
        method.Body.Instructions
            .Where(instruction => instruction.Operand is string)
    ...
    private static (HashSet<string> Buttons, HashSet<string> Groups, HashSet<string> Fields) GeneratedControls(
    ...
    private static IEnumerable<string> PreviousStrings(
