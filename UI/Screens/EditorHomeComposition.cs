...
public static class EditorHomeComposition
{
    ...
    public static readonly Element[] Elements =
    {
        ...
        new Element("Button", "EditorNewMission", "NEW MISSION", 124, 364, 292, 34),
        new Element("Field", "EditorContentName", "New mission", 460, 302, 692, 38),
        new Element("Text", "CreatorHeading", "WEB CREATOR", 124, 406, 292, 28, 20),
        new Element("Text", "CreatorHelp", "Manage missions, levels and story in Creator.", 124, 438, 292, 34),
