...
[Injectable]
public class SecureSplitItemPatch(SecureContainerRestrictions restrictions) : AbstractPatch
{
    ...
    protected override MethodBase GetTargetMethod()
    {
        ...
        return AccessTools.Method(typeof(InventoryController), nameof(InventoryController.SplitItem));
    }
