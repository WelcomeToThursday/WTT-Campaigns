            ...
            if (r.Definition != null)
            {
                ...
                )
                {
                    ...
                    if (
                        r.Version < 6
                        && (
                            baseline.MapLayouts.Any(MapLayoutRules.NeedsFormat9)
                            || draft.Definition.MapLayouts.Any(MapLayoutRules.NeedsFormat9)
                            || r.Definition.MapLayouts.Any(MapLayoutRules.NeedsFormat9)
                        )
                    )
                    ...
                    if (
                        r.Version < 5
                        && (
                            baseline.MapLayouts.Any(MapLayoutRules.NeedsFormat8)
                            || draft.Definition.MapLayouts.Any(MapLayoutRules.NeedsFormat8)
                            || r.Definition.MapLayouts.Any(MapLayoutRules.NeedsFormat8)
                        )
                    )
