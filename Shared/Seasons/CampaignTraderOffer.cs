...
public static class TraderOfferRules
{
    ...
    public static void Validate(SeasonDefinition definition, SeasonValidationResult result)
    {
        ...
        foreach (var assort in definition.TraderAssorts)
        {
            ...
            if (
                definition.FormatVersion is not (3 or 4 or 5 or 6 or 7 or 8 or 9 or 10 or 11 or 12 or 13)
        ...
        foreach (var offer in definition.TraderOffers)
        {
            ...
            Need(definition.FormatVersion is 3 or 4 or 5 or 6 or 7 or 8 or 9 or 10 or 11 or 12 or 13, "Trader offers require campaign format 3.");
            Need(
