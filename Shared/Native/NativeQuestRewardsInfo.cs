...
public sealed class NativeQuestRewardsInfo : NativeModel
{
    ...
    public NativeQuestRewardsInfoIllustrationConfig? IllustrationConfig { get; set; }
    ...
    public List<NativeQuestRewardsInfoItems>? Items { get; set; }
