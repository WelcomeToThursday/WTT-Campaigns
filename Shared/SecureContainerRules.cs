...
public static class SecureContainerRules
{
    ...
    public const string Message =
        "Broken Secure Container prevents placing this item or its contents in the secure container.";
    ...
    public static bool Allows(
        ...
        effects
            .Matching(EffectId)
            .All(e => RuntimeEffects.MatchesFilter(e.ItemFilter, templateId, ancestors));
}
