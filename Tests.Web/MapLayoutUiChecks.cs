...
internal static class MapLayoutUiChecks
{
    internal static async Task Run(IServiceProvider services, Action<bool, string> check)
    {
        ...
        var asset = new MapTarget { Kind = "AssetContainer", Bundle = "assets/crate.bundle", Asset = "assets/crate.prefab", Template = "578f8778245977358849a9b5" };
        asset.Fingerprint = SceneAssetRules.Identity(asset.Bundle, asset.Asset);
        map.Objects.Add(new MapObjectEdit { Id = SeasonRepository.NewId(), Name = "Native crate", Location = map.Location, Scene = "woods_main", Target = asset, Operation = "Copy" });
        ...
        await renderer.Dispatcher.InvokeAsync(async () =>
        {
            ...
            check(renderer.Text(component.Id).Contains("assets/crate.bundle") && renderer.Text(component.Id).Contains("Native random-loot container"),
            ...
            check(season.MapLayouts[1].Objects[0].Target.Asset == asset.Asset && season.FormatVersion == 8,
