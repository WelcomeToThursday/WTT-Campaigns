...
`CampaignScreen.Introduction` owns the separate five-page season introduction opened from the seasonal profile card. See [player introduction guide](../wiki/season-introduction.md).
