...
Dependencies are separate downloads. Install matching WTT-Campaigns client, UI and server components from the same release. See [installation](https://github.com/WelcomeToThursday/WTT-Campaigns#installation).
...
Campaign authors choose which supported perks and common rules their campaign offers. Personal effects apply to the active campaign PMC. The separate [trader progression changes](https://github.com/WelcomeToThursday/WTT-Campaigns/wiki/trader-progression) also affect regular characters.
...
See the [perk guides](https://github.com/WelcomeToThursday/WTT-Campaigns/wiki/Home#perk-details) for resource rounding, prices, symptoms and other details.
...
The [Battle Pass](https://github.com/WelcomeToThursday/WTT-Campaigns/wiki/battle-pass-gameplay) supports local claims, exchanges and saved character progress. A reward being locked does not mean all reward transactions are unavailable.
...
For missing characters or migration conflicts, see [profile recovery](https://github.com/WelcomeToThursday/WTT-Campaigns/wiki/typed-models-and-profile-storage). For content that will not publish or play, see [Creator troubleshooting](https://github.com/WelcomeToThursday/WTT-Campaigns/wiki/creator-tutorials#troubleshooting).
