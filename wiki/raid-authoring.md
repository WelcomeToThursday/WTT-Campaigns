...
The vertical rail directly below **Undo/Redo** opens **Layouts**, **Routes**, **Zones**, **Events**, **Captures**, **Scene**, and **AI**. All seven tool windows can stay open together. Each retains its own search, filters, page, scrolling, tree expansion, and selection. Clicking a rail icon opens or focuses that tool; its edge marker shows that it is open, and the highlighted icon identifies the active tool. Creation and picking actions stay inside their tool window.
